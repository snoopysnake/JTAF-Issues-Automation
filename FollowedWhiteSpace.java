 ...
 */
public class FollowedWhiteSpace {
    public static void main(String[] args) throws Exception {
        String errorName = "'[keyword]' is not followed by whitespace.";
        String location = "C:\\Users\\K26151\\Documents\\";
        ErrorParser parser = new ErrorParser("https://github.com/FINRAOS/JTAF-XCore/issues/64");
        for(String f:parser.getPaths()) {
            for (String e : parser.getErrors(f)) {
                String keyword = e.split("'")[1]; //gets keyword from error msg
                //prints locations
